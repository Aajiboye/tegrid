...
export class HomeOwnerKycController {
    ...
    async verifyPhoneNumber(@user() user: User, @Body() payload: HomeOwnerPhoneVerifyDto) {
    ...
    async requestPhoneVerificationOtp(@user() user: User, @Body() payload: HomeOwnerPhoneRequestDto) {
